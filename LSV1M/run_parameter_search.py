...
# SIMULATION_NAME = 'L5ab-Mixed'
# SIMULATION_NAME = 'L5a-TurnedOff'
SIMULATION_NAME = 'L5b-test'

# SIMULATION_NAME = 'L5desnity-equal-updated'
# SIMULATION_NAME = 'L5desnity-20-80-updated'
...
if True:
    CombinationParameterSearch(
            ...
            path_to_mozaik_env = '/home/haman/virt_env/layers56/bin/activate'),
        {
            ...
            # L5 DENSITY test
            # 'l5ab_density_ratio' : [1.],
            # 'l5a_density' : [19300, 15000, 10000, 5000, 1000, 820],
            # 'l5a_density' : [4000, 3000, 2000, 1000, 820],
            ...
            'sheets.l5_cortex_exb.l23_aff_ratio' : [0.0],
